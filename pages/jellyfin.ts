...
class jellyfinPage {
  ...
  selectMoviesLibrarySection = "//div[@data-id='f137a2dd21bbc1b99aa5c0f6bf02a805']//button[contains(@class, 'paper-icon-button-light')]";
  ...
  refreshMoviesLibrary() {
    ...
    I.click(this.selectMoviesLibrarySection);
